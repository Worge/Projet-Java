...
import controlleur.apprentissage.ControllerApprentissageJeu;
...
public class ControllerExamen implements Initializable{
    private Stage stage;
    ...
    public ControllerExamen(Stage s) {
        stage =s;
    }
    ...
    public void go() throws IOException {
        ...
        if (!ok){
            ...
            //TODO Mettre une Image d'erreur !!!!!
        }
        else {
            ...
            //TODO récupéré les cartes dans chaque piles est les mettres dans l'ArrayList
...
/*
    ...
    public void labelFacile(){
        Facile.setVisible(true);
    }

    public void labelFacile2(){
